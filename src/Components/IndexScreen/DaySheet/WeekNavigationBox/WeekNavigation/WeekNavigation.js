...
function WeekNavigation({startingDate,date,endingDate,week,changeDate}) {
  ...
  return (
    <div class="top">
      <a href="javascript:;" class="prev" onClick={e=>changeDate(new Date(date.setDate(date.getDate()-7)))}>
      ...
      <a href="javascript:;" class="next" onClick={e=>changeDate(new Date(date.setDate(date.getDate()+7)))}>
